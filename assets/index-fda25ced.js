 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IP{constructor(e){this.app=e}_delete(){return delete js[this.app.options.appId],Promise.resolve()}}let js={},Kd=[];const zd={};let qc="dataLayer",wP="gtag",Wd,k_,Gd=!1;function TP(){const t=[];if(Zm()&&t.push("This is a browser extension environment."),Vb()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,s)=>`(${s+1}) ${r}`).join(" "),n=yt.create("invalid-analytics-context",{errorInfo:e});ht.warn(n.message)}}function AP(t,e,n){TP();const r=t.options.appId;if(!r)throw yt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)ht.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw yt.create("no-api-key");if(js[r]!=null)throw yt.create("already-exists",{id:r});if(!Gd){rP(qc);const{wrappedGtag:i,gtagCore:o}=aP(js,Kd,zd,qc,wP);k_=i,Wd=o,Gd=!0}return js[r]=EP(t,Kd,zd,e,Wd,qc,n),new IP(t)}function bP(t=Fa()){t=be(t);const e=Bn(t,Qo);return e.isInitialized()?e.getImmediate():RP(t)}function RP(t,e={}){const n=Bn(t,Qo);if(n.isInitialized()){const s=n.getImmediate();if(ai(e,n.getOptions()))return s;throw yt.create("already-initialized")}return n.initialize({options:e})}function $l(t,e,n,r){t=be(t),yP(k_,js[t.app.options.appId],e,n,r).catch(s=>ht.error(s))}const Qd="@firebase/analytics",Jd="0.10.0";function SP(){Nt(new Tt(Qo,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return AP(r,s,n)},"PUBLIC")),Nt(new Tt("analytics-internal",t,"PRIVATE")),ut(Qd,Jd),ut(Qd,Jd,"esm2017");function t(e){try{const n=e.getProvider(Qo).getImmediate();return{logEvent:(r,s,i)=>$l(n,r,s,i)}}catch(n){throw yt.create("interop-component-reg-failed",{reason:n})}}}SP();const PP={data(){return{analyticsData:[]}},components:{adminNav:Tb,Icon:Hm},mounted(){this.fetchAnalyticsData()},methods:{async fetchAnalyticsData(){try{const t=bP();await $l(t,"user_signup",{method:"email"}),await $l(t,"page_view",{page_path:"/dashboard"});const e=[{name:"user_signup",params:{method:"email"}},{name:"page_view",params:{page_path:"/dashboard"}}];this.analyticsData=e}catch(t){console.error("Error fetching analytics data:",t)}}}},CP=t=>(Ou("data-v-86fda279"),t=t(),Du(),t),kP={class:"container my-4"},OP=CP(()=>$("h1",null,"Admin Dashboard",-1)),DP={class:"mt-4"},NP={class:"container my-5"},xP=kw('<div class="row" data-v-86fda279><div class="col-lg-3 col-md-6 mt-3" data-v-86fda279><div class="jumbotron shadow py-5" data-v-86fda279><div class="container" data-v-86fda279><h3 class="text-center" data-v-86fda279>Users</h3><p class="text-center" data-v-86fda279>0</p></div></div></div><div class="col-lg-3 col-md-6 mt-3" data-v-86fda279><div class="jumbotron shadow py-5" data-v-86fda279><div class="container" data-v-86fda279><h3 class="text-center" data-v-86fda279>Payments</h3><p class="text-center" data-v-86fda279>0</p></div></div></div><div class="col-lg-3 col-md-6 mt-3" data-v-86fda279><div class="jumbotron shadow py-5" data-v-86fda279><div class="container" data-v-86fda279><h3 class="text-center" data-v-86fda279>Complaints</h3><p class="text-center" data-v-86fda279>0</p></div></div></div><div class="col-lg-3 col-md-6 mt-3" data-v-86fda279><div class="jumbotron shadow py-5" data-v-86fda279><div class="container" data-v-86fda279><h3 class="text-center" data-v-86fda279>Health</h3><p class="text-center text-success" data-v-86fda279>Good</p></div></div></div></div>',1),MP={class:"nav nav-underline flex-column"},VP={class:"nav-item"},LP={class:"nav-link",href:"#"},FP={class:"nav-item"},UP={class:"nav-link",href:"#"};function $P(t,e,n,r,s,i){const o=sr("adminNav"),a=sr("Icon"),c=sr("RouterLink");return Sa(),Vu("main",null,[ee(o),$("div",kP,[OP,$("h5",DP,[ct("Add Data To Database "),ee(a,{icon:"iconamoon:edit-duotone"})])]),$("div",NP,[xP,$("ul",MP,[$("li",VP,[$("a",LP,[ee(c,{to:"/all-events",class:"route"},{default:gt(()=>[ee(a,{icon:"tabler:pencil",color:"white"}),ct(" Events")]),_:1})])]),$("li",FP,[$("a",UP,[ee(c,{to:"/all-course",class:"route"},{default:gt(()=>[ee(a,{icon:"tabler:pencil",color:"white"}),ct(" Courses")]),_:1})])])])])])}const BP=Ma(PP,[["render",$P],["__scopeId","data-v-86fda279"]]);const jP={},rh=t=>(Ou("data-v-92baf67e"),t=t(),Du(),t),qP={class:""},HP={class:"page_404 d-flex justify-content-center align-items-center"},KP={class:"container"},zP={class:"row"},WP={class:"col"},GP={class:"col text-center"},QP=rh(()=>$("div",{class:"four_zero_four_bg"},[$("h1",{class:"text-center text-dark"},"404")],-1)),JP={class:"contant_box_404"},XP=rh(()=>$("h3",{class:"h2 text-dark"}," Look like you're lost ",-1)),YP=rh(()=>$("p",{class:"text-dark"},"the page you are looking for not avaible!",-1));function ZP(t,e,n,r,s,i){const o=sr("router-link");return Sa(),Vu("div",qP,[$("section",HP,[$("div",KP,[$("div",zP,[$("div",WP,[$("div",GP,[QP,$("div",JP,[XP,YP,ee(o,{to:"/",class:"link_404"},{default:gt(()=>[ct("Go to Home")]),_:1})])])])])])])])}const eC=Ma(jP,[["render",ZP],["__scopeId","data-v-92baf67e"]]);var tC="firebase",nC="10.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jt(){return window}function nk(t){Jt().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sy(){return typeof Jt().WorkerGlobalScope<"u"&&typeof Jt().importScripts=="function"}async function rk(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function sk(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function ik(){return sy()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dk=new Ci(3e4,6e4);function lp(){const t=Jt().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function Nk(t){return new Promise((e,n)=>{var r,s,i;function o(){lp(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{lp(),n(Qt(t,"network-request-failed"))},timeout:Dk.get()})}if(!((s=(r=Jt().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=Jt().gapi)===null||i===void 0)&&i.load)o();else{const a=RC("iframefcb");return Jt()[a]=()=>{gapi.load?o():n(Qt(t,"network-request-failed"))},G_(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw Co=null,e})}let Co=null;function xk(t){return Co=Co||Nk(t),Co}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class ol{constructor(e,n){this.data=e,this.contentType=n||null}}function Xx(t,e){switch(t){case Wt.RAW:return new ol(PE(e));case Wt.BASE64:case Wt.BASE64URL:return new ol(CE(t,e));case Wt.DATA_URL:return new ol(Zx(e),eM(e))}throw lf()}function PE(t){const e=[];for(let n=0;n<t.length;n++){let r=t.charCodeAt(n);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const i=r,o=t.charCodeAt(++n);r=65536|(i&1023)<<10|o&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function Yx(t){let e;try{e=decodeURIComponent(t)}catch{throw Qs(Wt.DATA_URL,"Malformed data URL.")}return PE(e)}function CE(t,e){switch(t){case Wt.BASE64:{const s=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(s||i)throw Qs(t,"Invalid character '"+(s?"-":"_")+"' found: is it base64url encoded?");break}case Wt.BASE64URL:{const s=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(s||i)throw Qs(t,"Invalid character '"+(s?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Jx(e)}catch(s){throw s.message.includes("polyfill")?s:Qs(t,"Invalid character found")}const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}class kE{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw Qs(Wt.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=n[1]||null;r!=null&&(this.base64=tM(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function Zx(t){const e=new kE(t);return e.base64?CE(Wt.BASE64,e.rest):Yx(e.rest)}function eM(t){return new kE(t).contentType}function tM(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $E="storage";function JM(t,e,n){return t=be(t),vM(t,e,n)}function XM(t){return t=be(t),EM(t)}function YM(t,e){return t=be(t),AM(t,e)}function RM(t=Fa(),e){t=be(t);const r=Bn(t,$E).getImmediate({identifier:e}),s=Qm("storage");return s&&SM(r,...s),r}function SM(t,e,n,r={}){bM(t,e,n,r)}function PM(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new df(n,r,s,e,Er)}function CM(){Nt(new Tt($E,PM,"PUBLIC").setMultipleInstances(!0)),ut(fg,dg,""),ut(fg,dg,"esm2017")}CM();const kM={apiKey:"AIzaSyDV86E04pfIBPbQnfyeRoDPFiamVZz1lD4",authDomain:"coesa-dd1ed.firebaseapp.com",projectId:"coesa-dd1ed",storageBucket:"coesa-dd1ed.appspot.com",messagingSenderId:"262690091547",appId:"1:262690091547:web:7d96e73c81ccb843ddbebe",measurementId:"G-T7KRL108F3"},pf=s_(kM),gu=a1(pf),ZM=rx(pf);RM(pf);const ga=B0({history:r0("/"),routes:[{path:"/",redirect:"/dashboard",name:"admin",meta:{requiresAuth:!0}},{path:"/login",name:"login",component:()=>rn(()=>import("./adminLogin-5ec9588b.js"),["assets/adminLogin-5ec9588b.js","assets/adminLogin-6f80fcb8.css"])},{path:"/:catchAll(.*)",component:eC},{path:"/404",component:()=>rn(()=>import("./404-a6ff4bc1.js"),["assets/404-a6ff4bc1.js","assets/404-3e21175c.css"])},{path:"/dashboard",component:BP},{path:"/all-events",name:"admin-events",component:()=>rn(()=>import("./adminEvent-7079d099.js"),[])},{path:"/create-event",name:"admin-create-events",component:()=>rn(()=>import("./addEvent-1f95e6f6.js"),["assets/addEvent-1f95e6f6.js","assets/addEvent-bdb6c0ca.css"])},{path:"/create-course",name:"admin-create-course",component:()=>rn(()=>import("./addCourse-3622d377.js"),["assets/addCourse-3622d377.js","assets/addCourse-e91ac33a.css"])},{path:"/all-course",name:"admin-all-course",component:()=>rn(()=>import("./allCourses-1cfeba81.js"),["assets/allCourses-1cfeba81.js","assets/fullPageLoader-b2053037.js","assets/fullPageLoader-46d0c714.css","assets/allCourses-e859c7db.css"])},{path:"/all-course/:id",name:"CourseDetail",component:()=>rn(()=>import("./courseDetail-ee09e560.js"),["assets/courseDetail-ee09e560.js","assets/fullPageLoader-b2053037.js","assets/fullPageLoader-46d0c714.css","assets/courseDetail-dd2a12ab.css"]),props:!0,beforeEnter:(t,e,n)=>{const r=t.params.id;OM(r)?n():n("/404")}},{path:"/edit-course/:id/edit",name:"edit-course-detail",component:()=>rn(()=>import("./editCourse-c814c9ba.js"),["assets/editCourse-c814c9ba.js","assets/editCourse-d2530daf.css"]),props:!0},{path:"/edit-event/:id/edit",name:"edit-event-detail",component:()=>rn(()=>import("./editAdminEvent-47fb579f.js"),["assets/editAdminEvent-47fb579f.js","assets/editAdminEvent-312a8c44.css"]),props:!0}]});function OM(t){return!isNaN(parseInt(t))}ga.beforeEach((t,e,n)=>{t.path==="/dashboard"?gu.currentUser?n():n("/login"):n()});const DM=LT({state:{user:{id:null,username:null,email:null,password:null}},mutations:{SET_USER(t,e){t.user=e},CLEAR_USER(t){t.user={username:null,email:null,password:null}}},getters:{isAuthenticated:t=>!!t.user,getUserList:t=>t.userList},actions:{async login({commit:t},e){const{email:n,password:r}=e;try{await zC(gu,n,r),n==="admin@gmail.com"?(t("SET_USER",{email:n}),ga.push("/")):alert("You are not authorized as an admin.")}catch(s){switch(s.code){case"auth/user-not-founded":alert("user not found");break;case"auth/wrong-password":alert("wrong password");break;default:alert("Something went wrong")}return}},async logout({commit:t}){await QC(gu),t("CLEAR_USER"),ga.push("/login")}}}),NM={};function xM(t,e,n,r,s,i){const o=sr("RouterView");return Sa(),Sw(o)}const MM=Ma(NM,[["render",xM]]),gf=hT(MM);gf.use(DM);gf.use(ga);gf.mount("#app");export{GM as A,Bt as F,Hm as I,Ma as _,$ as a,BM as b,Vu as c,Du as d,ee as e,gt as f,ct as g,Tb as h,WM as i,zM as j,ZM as k,FM as l,RM as m,YM as n,Sa as o,Ou as p,JM as q,sr as r,XM as s,VM as t,jM as u,UM as v,LM as w,QM as x,$M as y,Sw as z};
