 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir{constructor(e,n){this._service=e,n instanceof wt?this._location=n:this._location=wt.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new Ir(e,n)}get root(){const e=new wt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return TE(this._location.path)}get storage(){return this._service}get parent(){const e=oD(this._location.path);if(e===null)return null;const n=new wt(this._location.bucket,e);return new Ir(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw FN(e)}}function ID(t,e,n){t._throwIfRoot("uploadBytes");const r=ED(t.storage,t._location,IE(),new Mn(e,!0),n);return t.storage.makeRequestWithTokens(r,PE).then(s=>({metadata:s,ref:t}))}function AD(t){t._throwIfRoot("getDownloadURL");const e=_D(t.storage,t._location,IE());return t.storage.makeRequestWithTokens(e,PE).then(n=>{if(n===null)throw MN();return n})}function RD(t,e){const n=aD(t._location.path,e),r=new wt(t._location.bucket,n);return new Ir(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
